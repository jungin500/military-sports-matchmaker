# 전투체육 매칭 어플리케이션 **{{ApplicationName}}**

# 개요
	군에서 전투체육 시간에 이용할 수 있는 **팀 매칭 어플리케이션**
전투체육 시간에 주변 사람들과 함께 특정 운동을 매칭하여, 같은 팀으로써 체력 단련을 할 수 있게 하는 어플리케이션이다. 생활관 TV와 사지방 앞에만 틀어박혀있지 말고, 이제 연병장으로 뛰어나오자!

## 주요 기능
- 팀 단위 상대방 매칭 가능
- 회원제 도입 및 군번 아이디와 자동 로그인 이용을 통한 편의성 증대
- 
