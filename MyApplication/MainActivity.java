...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.football:
                Intent intent = new Intent(getApplicationContext(), Match_setting.class);
                intent.putExtra("BIRTHDAY_KEY",11);
                startActivity(intent);
                break;
            case R.id.basketball:
                Intent intent1 = new Intent(getApplicationContext(), Match_setting.class);
                intent1.putExtra("BIRTHDAY_KEY",5);
                startActivity(intent1);
                break;
            case R.id.footwear:
                Intent intent2 = new Intent(getApplicationContext(), Match_setting.class);
